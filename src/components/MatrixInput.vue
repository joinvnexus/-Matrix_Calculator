  ...
  <div class="min-h-screen bg-gradient-to-br from-blue-900 via-purple-900 to-blue-900 text-gray-100 p-4 md:p-8">
    <div class="max-w-7xl mx-auto">
      ...
      <main class="space-y-8">
            ...
            <div class="mt-8 border-t pt-6">
              ...
              <div class="flex flex-wrap justify-center gap-3">
                <div v-for="(val, index) in vectorB" :key="index" class="flex flex-col items-center">
                  <label :for="'vector-b-' + index" class="text-xs text-gray-500 mb-1">b{{index + 1}}</label>
                  <input
                    :id="'vector-b-' + index"
        ...
        <!-- Error Alert -->
        <div v-if="error" class="bg-red-100 border-l-4 border-red-500 text-red-700 p-4 rounded shadow-md flex items-center gap-3">
